...
import { exportSingleEntryHtml } from '@/lib/exportHtml'
    ...
    <div className="bg-white rounded-xl border border-[#e8e5e0] p-5 shadow-[0_1px_3px_rgba(0,0,0,.08),0_4px_12px_rgba(0,0,0,.05)]">
      ...
      <div className="flex items-start justify-between gap-3 mb-3">
        ...
        <div className="flex gap-1 shrink-0">
          ...
          <button
            ...
            className={`p-1.5 rounded-lg transition-colors
              ${copied
                ...
                : 'text-[#a09890] hover:text-[#4a6fa5] hover:bg-[#eef2f8]'
              }`}
          >
            {copied ? (
          ...
          {/* HTML 내보내기 */}
          <button
            onClick={() => exportSingleEntryHtml(entry)}
      ...
      {/* 질문 */}
      <p
        className="text-[14px] text-[#6b6560] mb-3"
      ...
      {showConfirm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-white rounded-xl p-6 shadow-xl max-w-sm w-full mx-4">
            <p className="text-[15px] text-[#1a1816] mb-5">이 기록을 삭제할까요?</p>
